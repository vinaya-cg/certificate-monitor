...
# Manages CloudWatch dashboard for monitoring
    ...
    widgets = [
      {
        ...
        properties = {
          metrics = [
            ["AWS/Lambda", "Duration", "FunctionName", var.certificate_monitor_function_name],
            [".", "Errors", ".", "."],
            [".", "Invocations", ".", "."]
          ]
          view    = "timeSeries"
      ...
      },
      {
        ...
        properties = {
          metrics = [
            ["AWS/DynamoDB", "ConsumedReadCapacityUnits", "TableName", var.certificates_table_name],
